...
export const contentM12Premium = `
# PROJETO FINAL: CAMPANHA COMPLETA PARA TIKTOK SHOP
## Módulo 12 — Projeto Final e Encerramento

Parabéns por chegar ao estágio final da sua jornada na FCIA Academy. Você percorreu um caminho denso: da mentalidade de nichos à maestria na criação de influenciadores virtuais, passando pela técnica de vídeo, voz, roteiro e operação de escala.

Este módulo não é apenas uma conclusão; é o campo de batalha. Aqui, você integrará todas as peças do quebra-cabeça para lançar o seu **Dossiê Final de Campanha**. Este documento será o seu guia operacional para executar sua primeira (ou próxima) grande campanha lucrativa no TikTok Shop.
