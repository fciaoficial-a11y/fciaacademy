...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FCIA Academy — Cursos e Treinamentos com Certificação" },
      { property: "og:description", content: "Plataforma FCIA Academy: cursos e treinamentos aplicados com certificação digital reconhecida." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "FCIA Academy" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FCIA Academy — Cursos e Treinamentos com Certificação" },
      { name: "twitter:description", content: "Plataforma FCIA Academy: cursos e treinamentos aplicados com certificação digital reconhecida." },
    ],
    links: [
