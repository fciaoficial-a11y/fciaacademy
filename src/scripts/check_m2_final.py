...
async def main():
    async with async_playwright() as playwright:
        ...
        await page.screenshot(path=str(SCREENSHOTS / "m2_final_check.png"))
        
        content = await page.content()
        # Blocos atualizados (MÉTODO PROVA sem pontos para evitar falha no check de texto)
        blocks_to_check = [
        ...
        # Verificar video_url = NULL no banco (indiretamente pelo render)
